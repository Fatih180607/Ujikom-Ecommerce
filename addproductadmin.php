...
<body>
    ...
    <div class="content">
        ...
        <form action="addproductadmin.php" method="POST" autocomplete="off" enctype="multipart/form-data">
            ...
            <select class="dropdown_kategori" name="Kategori" id="kategori" required>
                <option value="">Pilih Kategori</option>
                <?php
                foreach ($kategori_list as $kategori) {
                    echo "<option value='" . htmlspecialchars($kategori['ID']) . "'>" . htmlspecialchars($kategori['Kategori']) . "</option>";
                }
                ?>
            </select>

            <label for="Kategori_liga">Liga:</label>
            <select class="dropdown_kategoriliga" name="Kategori_liga" id="kategori_liga" required>
                <option value="">Pilih Liga</option>
                <?php
                foreach ($kategori_liga as $liga) {
                    echo "<option value='" . htmlspecialchars($liga['ID']) . "'>" . htmlspecialchars($liga['Nama_Liga']) . " - " . htmlspecialchars($liga['Negara']) . "</option>";
                }
                ?>
            </select>
        ...
        <script>
            function addSize() {
                ...
                newRow.innerHTML = `<input type="text" name="size[]" placeholder="Ukuran (S, M, L)" required>
